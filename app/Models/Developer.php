...
class Developer extends Model
{
    ...
    public static function getPlan(array $developers = []): array|string
    {
    ...
    private static function assignTaskToDeveloper(array $developerList = []): array|string
    {
    ...
    private static function findDeveloperLevel(array $developers, int $level): int
    {
    ...
    private static function weeklyGroup(array $tasks = []): array
    {
        $weeklyTasks = [
            [
                'tasks' => [],
